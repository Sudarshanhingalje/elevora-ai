...
export default function ParticlesComponent({ className = "" }) {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      // observe changes from theme buttons
  ...
  return (
    <div
      ...
      className={`
        ...
        ${className || "bg-gradient-to-tr from-[#e3f2fd] via-[#90caf9] to-[#64b5f6] dark:from-[#000814] dark:via-[#003566] dark:to-[#0077b6]"}
      `}
    />
  );
}
